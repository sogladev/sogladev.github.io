...
- Use the [wow-realm-switch-utility](https://github.com/sogladev/wow-realm-switch-utility) to automatically launch clients with different `realmlist.wtf` configurations.

For multi-core scenarios beyond AC1/AC2, see the companion article: [Cross-Core Triage: AzerothCore, TrinityCore, MaNGOS](./cross-core-triage).
