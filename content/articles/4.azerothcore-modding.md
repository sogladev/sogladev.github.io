...
You can create a staging area with the `build-mpq` command:


```sh
build-mpq create /home/pc/Desktop/acore-custom-staging/patch-Z.MPQ
```
Source: https://github.com/sogladev/build-mpq (PyPI: https://pypi.org/project/build-mpq/)
...
See the unfinished modding demo: [mod-caravan](https://github.com/sogladev/mod-caravan)
