...
- Use the [rs-realmctl](https://github.com/sogladev/rs-realmctl) to automatically launch clients with different `realmlist.wtf` configurations.
...
Also see [wiki - Useful Tools](https://www.azerothcore.org/wiki/useful-tools)
